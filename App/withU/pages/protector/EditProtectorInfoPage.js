...
export default function EditProtectorInfoPage({navigation}) {
  ...
  return (
    <ScrollView style={{backgroundColor:"#fff"}}>
      <Image style={styles.image} source={require('../../assets/defaultUserImage.png')}/>
      ...
      <View style={styles.container}>
        ...
        <View style={{flex:5}}>
          <View style={styles.infoContainer}><TextInput style={styles.info} >{ProtectorInfo.name}</TextInput></View>
          <View style={styles.infoContainer}><TextInput style={styles.info} >{ProtectorInfo.gender}</TextInput></View>
          ...
          <View style={styles.infoContainer}><TextInput style={styles.info} multiline={true} >{ProtectorInfo.address}</TextInput></View>
          <View style={styles.numContainer}>
            <TextInput style={styles.innerNumContainer} keyboardType="numeric">{phoneArray[0]}</TextInput>
            <Text style={styles.info}> - </Text>
            <TextInput style={styles.innerNumContainer} keyboardType="numeric">{phoneArray[1]}</TextInput>
            <Text style={styles.info}> - </Text>
            <TextInput style={styles.innerNumContainer} keyboardType="numeric">{phoneArray[2]}</TextInput>
          </View>
          <View style={styles.infoContainer}><TextInput style={styles.info} >{ProtectorInfo.userId}</TextInput></View>
          <View style={styles.infoContainer}><TextInput style={styles.info} >{ProtectorInfo.relationship}</TextInput></View>
        </View>
      </View>
    </ScrollView>
  )
