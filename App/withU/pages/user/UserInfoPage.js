    ...
    <ScrollView style={{ backgroundColor: "#fff" }}>
      ...
      <View style={styles.container}>
        ...
        <View style={{ flex: 11 }}>
          ...
          <View style={styles.infoContainer}>
            <Text style={styles.info}>{userInfo.birth}</Text>
          </View>
          <View style={styles.infoContainer}>
            <Text style={styles.info}>{userInfo.address}</Text>
          </View>
          <View style={styles.infoContainer}>
            <Text style={styles.info}>{userInfo.userPhone}</Text>
          </View>
          <View style={styles.infoContainer}>
            <Text style={styles.info}>{userInfo.NOKPhone}</Text>
          </View>
          <View style={styles.infoContainer}>
            <Text style={styles.info}>{userInfo.disease}</Text>
          </View>
          <View style={styles.infoContainer}>
